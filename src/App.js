             ...
             <form>
               <input type="text" className="form-control" placeholder="Add data..." 
                ...
                <button type="button" className="btn btn-primary"
                 onClick={this.storeFinalData}>Add Data</button>
             </form>
           </div>
          </div>
        </div>
           ...
           <div className="card-body">
             <ul className="list-Group">
               {this.state.storeData.map((item,index)=>(
                 ...
                 <button className="btn btn-danger" id={index} onClick={(deleteEvent)=>this.
                   deleteStoreData(deleteEvent)}>delete</button></li>
               ))}
             </ul>
           </div>
          </div>
